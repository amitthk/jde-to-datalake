#+TITLE: JDE to Bakery Operations Data Ingestion System
...
JDE_PO_URL=https://your-jde-server/jderest/v3/orchestrator/JDE_PO_SUMMARY
JDE_PO_USERNAME=your_username
JDE_PO_PASSWORD=your_password
...
curl -u $JDE_PO_USERNAME:$JDE_PO_PASSWORD \
     $JDE_PO_URL

# Test JDE authentication
curl -i -u $JDE_PO_USERNAME:$JDE_PO_PASSWORD \
     $JDE_PO_URL
